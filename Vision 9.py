...
def get_diagnosis(age, screen_time, device, eye_issues, lifestyle_factors):
    ...
    elif 10 < screen_time <= 15:
        preventive_measures.append("Intensify visual comfort measures, Consult an eye specialist regularly")
    elif 15 < screen_time <= 20:
        preventive_measures.append("Implement comprehensive eye care routine, Increase frequency of eye exams")
...
screen_time = st.number_input("Screen Time (hours per day)", min_value=0, max_value=20, value=1)
